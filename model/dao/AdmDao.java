...
public class AdmDao {
    ...
    public int retornar_num_inscricoes_total() {
        ...
        try {
            stmt = con.prepareStatement("select id from alunos where curso = 'ADM'");
    ...
    public double retornar_media() {
        ...
        try {
            stmt = con.prepareStatement("select media from alunos where curso = 'ADM'");
    ...
    public List<Aluno> listarAdm(int num_ampla_publica, int num_cota_publica,
    ...
    public int retornar_num_cota_publica_adm() {
        ...
        sql = "select bairro from alunos where curso = 'ADM' and escola = 'Publica' order by media desc limit 32;";
    ...
    public int retornar_num_cota_particular_adm() {
        ...
        sql = "select bairro from alunos where curso = 'ADM' and escola = 'Particular' order by media desc limit 8;";
