...
public class InfDao {
    ...
    //Todas cotas de bairro já preenchidas
      ...
      public int retornar_num_inscricoes_total(){
        ...
        int i = 0;
        try {
            stmt = con.prepareStatement("select id from alunos where curso = 'INF'");
      ...
      public List<Aluno> listarInf(int num_ampla_publica, int num_cota_publica,
        ...
        try {
            stmt = con.prepareStatement("select media from alunos where curso = 'INF'");
    ...
    public int retornar_num_cota_publica_INF() {
        ...
        List<Aluno> alunos = new ArrayList<>();
         ...
         sql = "select bairro from alunos where curso = 'INF' and escola = 'Publica' order by media desc limit 32;";
    ...
    public int retornar_num_cota_particular_INF() {
        ...
        int i = 0;
         ...
         sql = "select bairro from alunos where curso = 'INF' and escola = 'Particular' order by media desc limit 8;";
